            ...
            <main className="bg-white px-10 md:px-20 lg:px-40">
                <section className="min-h-screen">
                  ...
                  <ul className="flex items-center">
                    ...
                    <li> 
                        <a className="bg-gredient-to-r bg-cyan-500 to-teal-500 text-white px-4 py-2 rounded-md ml-8" href="#">Download-CV</a>
                    </li>
                  </ul>
                  </nav>
                ...
                <section>
                    ...
                    <div className="text-center shadow-lg p-10 rounded-xl my-10">
                        <div className="flex flex-col items-center">
                           ...
                           <p className="py-2">
                           excel in creating prototypes with precision, combining creativity and functionality to deliver seamless user experiences
                           </p>
                           <h4 className="py-4 text-teal-600">Design tools I use</h4>
